      ...
      {loading ? <Loader /> : <>
        ...
        <div className="bg-gray-200 flex flex-wrap justify-evenly p-14 gap-10">
          ...
          <div className="">
            ...
            <button onClick={submitReviewToggle} className="text-xs text-white font-medium bg-customOrange-tomato hover:bg-customOrange-tomatohover transition-all duration-500 px-5 py-1 rounded-xl"></button>
          </div>
        </div>
